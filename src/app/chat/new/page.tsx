                                    ...
                                    <Drawer>
                                        ...
                                        <DrawerContent className="max-h-[90vh] overflow-y-auto">
                                                ...
                                                <div className="min-h-[200px] p-4 flex items-center justify-center">
                                                    <div className=" w-full max-w-4xl mx-auto  bg-gray-200 rounded-md ">
                                                        ...
                                                        <div className="h-24 md:h-20 flex  items-center justify-center  p-4">
                                                            <h3 className="text-sm md:text-base">You asked</h3>
                                                            <span className="text-2xl md:text-3xl font-bold mx-2 md:mx-4">
                                                                {chat.messages.length}
                                                            </span>
                                                            <h3 className="text-sm md:text-base">Questions</h3>
                                                        </div>
                                                        {/* Middle */}
                                                        <div className="h-24 md:h-20 flex  items-center justify-center gap-2 p-4">
                                                            ...
                                                            <Dialog>
                                                                ...
                                                                <DialogContent className="w-[90vw] max-w-[425px] p-4">
                                                                    <DialogHeader>
                                                                        <DialogTitle className="mb-3 text-lg md:text-xl">Save This Chat</DialogTitle>
                                                                        <DialogDescription>
                                                                    ...
                                                                    <DialogFooter className="justify-end mt-4">
                                                                        <DialogClose asChild>
                                                                            <Button type="button" variant="outline" onClick={savedMessage}>
                                                                                Save Chat
                                                                            </Button>
                                                                        </DialogClose>
                                                                    </DialogFooter>
                                            ...
                                            <DrawerFooter className="mt-4">
                                                <DrawerClose asChild >
                                                    <Button variant="outline" className="max-w-100 mx-auto">
                                                        Close
                                                    </Button>
                                                </DrawerClose>
                                            </DrawerFooter>
                                        ...
                                        {chat.messages.length === 0 ? (
                                            ...
                                            chat.messages.map((message, index) => (
                                                <div key={message.id} className="flex items-center">
                                                    ...
                                                    >
                                                        <Trash2
                                                            className="w-4 h-4 text-white transition-colors duration-200"
                                                        />
                                                    </div>
                                                </div>
                                            ))
